"""
Django settings for cybercheck project.
...
LOGIN_REDIRECT_URL = 'pages:dashboard'   # يوجه المستخدم بعد الـ login
LOGOUT_REDIRECT_URL = 'pages:home'  # يوجه المستخدم بعد الـ logout